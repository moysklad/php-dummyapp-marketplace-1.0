...
* защита от CSRF и корректная политика cookie (`SameSite`/`Secure`) для embedded-сценариев;
...
* Авторизованный запрос к backend (`utils/get-object.php`) через cookie и `$_SESSION`
